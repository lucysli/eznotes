...
$.TokenList = function (input, url_or_data, settings) {
    ...
    function highlight_term(value, term) {
        return value.replace(new RegExp("(?![^&;]+;)(?!<[^<>]*)(" + term.replace(/[$-\/?[-^{|}]/g, '\\$&') + ")(?![^<>]*>)(?![^&;]+;)", "gi"), "<b>$1</b>");
    }
    
    function find_value_and_highlight_term(template, value, term) {
        return template.replace(new RegExp("(?![^&;]+;)(?!<[^<>]*)(" + value.replace(/[$-\/?[-^{|}]/g, '\\$&') + ")(?![^<>]*>)(?![^&;]+;)", "g"), highlight_term(value, term));
    }
...
(function() {
  var filterSearch, filtering, ready, search;

  filterSearch = function(selector, query) {
    query = $.trim(query);
    query = query.replace(/\ /gi, '|');
    if (query === "red") {
      $('tr.error').show().addClass('visible');
      $('tr.success').hide().removeClass('visible');
      return $('tr.warning').hide().removeClass('visible');
    } else if (query === "green") {
      ...
      $('tr.error').hide().removeClass('visible');
      $('tr.success').hide().removeClass('visible');
      return $('tr.warning').show().addClass('visible');
    } else {
  ...
  filtering = function() {
    if (event.keyCode === 27 || $(this).val() === '') {
      ...
      return filterSearch('tbody tr', $(this).val());
    }
  };
  ...
  ready = function() {
    ...
    return $('thead th.sortable').each(function(column) {
      return $(this).click(function() {
        ...
        return $("td").removeClass("sorted").filter(":nth-child(" + (column + 1) + ")").addClass("sorted");
      });
    });
  };
...
(function() {
  var filterSearch, filtering, ready;
  ...
  filtering = function() {
    if (event.keyCode === 27 || $(this).val() === '') {
      $(this).val('');
      return $('div dl.course').removeClass('visible').show().addClass('visible');
    } else {
      return filterSearch('div dl.course', $(this).val());
    }
  };
  ...
  ready = function() {
    ...
    $('#course_filter').show();
    return $('#course_filter').keyup(filtering);
  };
...
(function() {
  ...
  updateCountdown = function() {
    ...
    $(".countdown").css("color", ((140 >= remaining && remaining >= 21) ? "gray" : void 0));
    $(".countdown").css("color", ((21 > remaining && remaining >= 11) ? "black" : void 0));
    return $(".countdown").css("color", (11 > remaining ? "red" : void 0));
  };

  ready = function() {
    $('#note_comments').change(updateCountdown);
    return $('#note_comments').keyup(updateCountdown);
  };
...
(function() {
  ...
  ready = function() {
    return $('#user_course_tokens').tokenInput("/registrations.json", {
      crossDomain: false,
      theme: "facebook",
...
(function() {
  var appendEmailAddress;

  appendEmailAddress = function() {
    var emailAddress, emailPattern, index, text;
    text = $('#session_email').val();
    if (text.length === 0) {
      return;
    }
    emailPattern = /.*@(mail.mcgill.ca|mcgill.ca)/i;
    index = text.indexOf("@");
    emailAddress = "@mail.mcgill.ca";
    if (emailPattern.test(text)) {
      return $('#session_email').val(text.substring(0, index) + text.substring(index));
    } else {
      return $('#session_email').val(text.substring(0, index) + emailAddress);
    }
  };

}).call(this);
(function() {
  var appendEmailAddress, ready;

  appendEmailAddress = function() {
    var emailEnd, emailPattern, index, text;
    ...
    if (emailPattern.test(text)) {
      ...
      if (index !== -1) {
        return $('#signup_email').val(text.substring(0, index + emailEnd.length));
      } else {
        return $('#signup_email').val(text.substring(0, text.indexOf("@")) + emailEnd);
      }
    } else {
      return $('#signup_email').val(text + emailEnd);
    }
  };

  ready = function() {
    $('#signup_email').focusout(appendEmailAddress);
    return $("input").not("[type=submit]").jqBootstrapValidation();
  };
...
(function() {
  ...
  filtering = function() {
    if (event.keyCode === 27 || $(this).val() === '') {
      $(this).val('');
      return $('ul.users li').removeClass('visible').show().addClass('visible');
    } else {
      return filterSearch('ul.users li', $(this).val());
    }
  };
  ...
  ready = function() {
    ...
    $('.newMcGillEmail').tooltip({
      title: "Enter your email",
      placement: "left"
    });
    $('.newUserID').tooltip({
      title: "Enter your 9 digit student ID",
      placement: "left"
    });
    $('.newUserPassword').tooltip({
      title: "Enter your password minimum 8 characters",
      placement: "left"
    });
    $('.newUserConfirm').tooltip({
      title: "Confirm your new password",
      placement: "left"
    });
    $('.newNotetaker').tooltip({
      title: "Check box if you are applying to be a notetaker",
      placement: "left"
    });
    $('.editUserName').tooltip({
    ...
    $('.editUserPassword').tooltip({
      title: "Input your password to authenticate changes",
      placement: "right"
    });
    $('.editUserConfirm').tooltip({
      title: "Confirm your password",
      placement: "right"
    });
    $('.emailReset').tooltip({
      title: "Please input your full McGill Email that you registered with",
      placement: "right"
    });
    $('.registerCourses').tooltip({
      title: "Add your courses.                   You can register for more than one course at the same time.                  Please take note of the semester and course section",
      placement: "left"
    });
    $('#filter').tooltip({
      title: "input search text to filter data in table. Press esc key to reset.",
      placement: "left"
    });
    $('#course_filter').tooltip({
      title: "input search text to filter course data. Press esc key to reset",
      placement: "right"
    });
    $('#user_filter').tooltip({
      title: "input search text to filter user data. Press esc key to reset",
      placement: "right"
    });
    $('ul.users li').addClass('visible');
    $('#user_filter').show();
    return $('#user_filter').keyup(filtering);
  };
