...
(function() {
  ...
  appendEmailAddress = function() {
    ...
    if (emailPattern.test(text)) {
      ...
      return $('#session_email').val(text + emailAddress);
    }
  };

  ready = function() {
    $('#session_email').focusout(appendEmailAddress);
    return $('.email_selector').change(appendEmailAddress);
  };
...
(function() {
  ...
  appendEmailAddress = function() {
    var emailPattern, index, text;
    text = $('#user_email').val();
    emailPattern = /.*@mail.mcgill.ca/i;
    if (emailPattern.test(text)) {
      index = text.indexOf("@mail.mcgill.ca");
      return $('#user_email').val(text.substring(0, index + 15));
    } else {
      return $('#user_email').val(text + "@mail.mcgill.ca");
    }
  };

  ready = function() {
    return $('#user_email').focusout(appendEmailAddress);
  };
...
(function() {
  $(function() {
    ...
    return $('.editUserConfirm').tooltip({
